...
export class AuthService {
  ...
  SignUp(user: any) {
    return this.auth
      ...
      .then((result) => {
        ...
        this.http
          .post('http://18.181.218.216:8080/api/createuser', user)
          .subscribe((data: any) => {
            console.log(data);
  ...
  SignIn(user: any) {
    return this.auth
      ...
      .then((result) => {
        this.http
          .get(`http://18.181.218.216:8080/api/getsingleuser/${user.email}`)
          .subscribe((res: any) => {
  ...
  AuthSignup(provider: any) {
    return this.auth
      ...
      .then((result: any) => {
        this.http
          .post('http://18.181.218.216:8080/api/createuser', {
  ...
  AuthLogin(provider: any) {
    return this.auth
      ...
      .then((result: any) => {
        ...
        this.http
          .get(
            `http://18.181.218.216:8080/api/getsingleuser/${result.user.email}`
          )
          .subscribe((res: any) => {
            console.log(res, 'res');
